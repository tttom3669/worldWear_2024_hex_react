      ...
      <div className="container py-5 pt-30 pb-10">
        ...
        <div className="row justify-content-center">
          <div className="col-md-7">
            {/* 訂購人資訊 */}
            <div className="mb-8">
              <FormTitle title="訂購人資訊" borderColor={`border-nature-90`} titleBgColor={`bg-nature-90`} />
            ...
            {/* 收件方式 */}
            <div className="mb-8">
            <FormTitle title="收件方式" borderColor={`border-nature-90`} titleBgColor={`bg-nature-90`} />
              <div className="px-5 py-8 bg-white border border-nature-90">
                <div className="form-check mb-3">
                  <input className="form-check-input" type="checkbox" id="sameAsBuyer" defaultChecked />
                ...
                <div className="d-flex align-items-center gap-4 mb-3">
                  <div className="custom-radio">
                    <input type="radio" id="storePickup" name="shipping" className="form-check-input" />
                    <label className="form-check-label ms-2" htmlFor="storePickup">超商取貨</label>
                  </div>
                  <div className="custom-radio">
                    <input defaultChecked type="radio" id="homeDelivery" name="shipping" className="form-check-input" />
                    <label className="form-check-label ms-2" htmlFor="homeDelivery">宅配</label>
                  </div>
                </div>
                <div className="row align-items-center">
                  ...
                  <div className="col-md-3">
                    <input type="text" className="form-control" value="320" disabled />
                  </div>
                </div>

                <div className="mt-3">
                  <input type="text" className="form-control form-input" placeholder="詳細地址" defaultValue="中和路139號" />
                </div>
              </div>
            </div>
            ...
            {/* 付款方式 */}
            <div className="mb-8">
              <FormTitle title="付款方式" borderColor={`border-nature-90`} titleBgColor={`bg-nature-90`} />
              <div className="px-5 py-8 bg-white border border-nature-90">
                <div className="custom-radio d-flex mb-3">
                  ...
                  <label className="form-check-label" htmlFor="creditCard">信用卡</label>
                  <img src={getImgUrl('/images/checkout/ic_visa.png')} alt="ic_visa" className="ms-2" width="30" />
                  <img src={getImgUrl('/images/checkout/ic_master.png')} alt="ic_master" className="ms-2" width="30" />
            ...
            {/* 發票選項 */}
            <div className="">
              <FormTitle title="發票選項" borderColor={`border-nature-90`} titleBgColor={`bg-nature-90`} />
              <div className="px-5 py-8 bg-white border border-nature-90">
                <div className="form-check mb-3">
                  <input className="form-check-input" type="checkbox" id="invoiceData" defaultChecked />
          ...
          <div className="col-md-3">
            <div className="border">
              <FormTitle title="結帳明細" borderColor={`border-nature-90 border-1`} titleBgColor="bg-white text-nature-10 py-4" />
