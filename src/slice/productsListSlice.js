...
//         if (categoryParams.includes('/')) {
//           const pathParts = categoryParams.split('/');
          
//           // 對於三層結構 (例如: gender/category/subcategory)
//           if (pathParts.length === 3) {
//             const [genderType, categoryType, subCategoryType] = pathParts;
...
//             }
//           }
//           // 處理兩層結構 (例如: women/dress 或 men/jacket)
//           else if (pathParts.length === 2) {
//             const [genderType, categoryType] = pathParts;
